...
struct ImVec4
{
    ...
    operator ImU32() const {
        ...
        return (a > 0xff ? 0xff : a) * 0x1000000 + (r > 0xff ? 0xff : r) * 0x10000 + (g > 0xff ? 0xff : g) * 0x100 + (b > 0xff ? 0xff : b);
}
...
enum ImGuiCol_
{
    ...
    ImGuiCol_DockingPreview_1,
    ImGuiCol_DockingOutLine,
    ImGuiCol_DockingLine,
    ImGuiCol_COUNT
