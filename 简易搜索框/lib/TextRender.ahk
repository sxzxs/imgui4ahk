...
*/
      ...
      if (pBitmap != "") {
         ...
         ; Draw image scaled to a new width and height.
            ...
            DllCall("gdiplus\GdipDrawImageRectRectI", "ptr", gfx, "ptr", pBitmap, "int", x, "int", y, "int", w, "int", h, "int", 0, "int", 0, "int", width, "int", height, "int", 2, "ptr", ImageAttr, "ptr", 0, "ptr", 0)
            DllCall("gdiplus\GdipDisposeImageAttributes", "ptr", ImageAttr)
         }
      }
